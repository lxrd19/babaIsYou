...
public:
     ...
     */
    void save(const std::vector<std::vector<Box>>& board);
    /**
     ...
     */
    std::vector<std::vector<Box>> load();
    /**
     ...
     */
    std::vector<std::vector<Box> > changeLevel();
    ...
    /**
      ...
      * @return A 2D vector of Boxes representing the game board.
     */
    std::vector<std::vector<Box>> readBoardFromFile(const std::string& path);
